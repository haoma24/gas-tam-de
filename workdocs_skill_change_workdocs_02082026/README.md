...
- **Thư mục:** `workdocs_skill_change_workdocs_02082026`
- **Ngày:** 02/08/2026
- **Loại:** chore
- **Liên quan:** n/a
...
Đảm bảo mỗi change được ghi vào `CHANGESLOG.md` và mỗi lần implement chức năng có thư mục `workdocs_*` lưu lịch sử.
...
- Format thư mục: `workdocs_<mo-ta>_<ddmmyyyy>`
...
| `workdocs_docs_prd_architecture_02082026/` | added | Lịch sử docs |
| `workdocs_skill_change_workdocs_02082026/` | added | Lịch sử skill |
